 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.capability.impl.CompositeCapabilityImpl#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link org.nasdanika.models.capability.impl.CompositeCapabilityImpl#getResolvedCapabilities <em>Resolved Capabilities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeCapabilityImpl extends CapabilityImpl implements CompositeCapability {
	...
	protected EClass eStaticClass() {
		return CapabilityPackage.Literals.COMPOSITE_CAPABILITY;
	}
	...
	public EList<AbstractCapability> getCapabilities() {
		return (EList<AbstractCapability>)eDynamicGet(CapabilityPackage.COMPOSITE_CAPABILITY__CAPABILITIES, CapabilityPackage.Literals.CAPABILITY_DOMAIN__CAPABILITIES, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CapabilityPackage.COMPOSITE_CAPABILITY__CAPABILITIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case CapabilityPackage.COMPOSITE_CAPABILITY__RESOLVED_CAPABILITIES:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == CapabilityDomain.class) {
			switch (derivedFeatureID) {
				case CapabilityPackage.COMPOSITE_CAPABILITY__CAPABILITIES: return CapabilityPackage.CAPABILITY_DOMAIN__CAPABILITIES;
				case CapabilityPackage.COMPOSITE_CAPABILITY__RESOLVED_CAPABILITIES: return CapabilityPackage.CAPABILITY_DOMAIN__RESOLVED_CAPABILITIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == CapabilityDomain.class) {
			switch (baseFeatureID) {
				case CapabilityPackage.CAPABILITY_DOMAIN__CAPABILITIES: return CapabilityPackage.COMPOSITE_CAPABILITY__CAPABILITIES;
				case CapabilityPackage.CAPABILITY_DOMAIN__RESOLVED_CAPABILITIES: return CapabilityPackage.COMPOSITE_CAPABILITY__RESOLVED_CAPABILITIES;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == CapabilityDomain.class) {
			switch (baseOperationID) {
				case CapabilityPackage.CAPABILITY_DOMAIN___RESOLVE_CAPABILITY_REFERENCE__ABSTRACTCAPABILITY: return CapabilityPackage.COMPOSITE_CAPABILITY___RESOLVE_CAPABILITY_REFERENCE__ABSTRACTCAPABILITY;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case CapabilityPackage.COMPOSITE_CAPABILITY___RESOLVE_CAPABILITY_REFERENCE__ABSTRACTCAPABILITY:

 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.capability.impl.ProvidedCapabilityImpl#getEvidence <em>Evidence</em>}</li>
 *   <li>{@link org.nasdanika.models.capability.impl.ProvidedCapabilityImpl#getCapability <em>Capability</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProvidedCapabilityImpl extends NamedPeriodImpl implements ProvidedCapability {
	...
	protected EClass eStaticClass() {
		return CapabilityPackage.Literals.PROVIDED_CAPABILITY;
	}
	...
	public EList<Evidence> getEvidence() {
		return (EList<Evidence>)eDynamicGet(CapabilityPackage.PROVIDED_CAPABILITY__EVIDENCE, CapabilityPackage.Literals.EVIDENCE_DOMAIN__EVIDENCE, true, true);
	}
	...
	public AbstractCapability getCapability() {
		return (AbstractCapability)eDynamicGet(CapabilityPackage.PROVIDED_CAPABILITY__CAPABILITY, CapabilityPackage.Literals.PROVIDED_CAPABILITY__CAPABILITY, true, true);
	}
	...
	public NotificationChain basicSetCapability(AbstractCapability newCapability, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newCapability, CapabilityPackage.PROVIDED_CAPABILITY__CAPABILITY, msgs);
		return msgs;
	}
	...
	public void setCapability(AbstractCapability newCapability) {
		eDynamicSet(CapabilityPackage.PROVIDED_CAPABILITY__CAPABILITY, CapabilityPackage.Literals.PROVIDED_CAPABILITY__CAPABILITY, newCapability);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CapabilityPackage.PROVIDED_CAPABILITY__EVIDENCE:
				return ((InternalEList<?>)getEvidence()).basicRemove(otherEnd, msgs);
			case CapabilityPackage.PROVIDED_CAPABILITY__CAPABILITY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EvidenceDomain.class) {
			switch (derivedFeatureID) {
				case CapabilityPackage.PROVIDED_CAPABILITY__EVIDENCE: return CapabilityPackage.EVIDENCE_DOMAIN__EVIDENCE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EvidenceDomain.class) {
			switch (baseFeatureID) {
				case CapabilityPackage.EVIDENCE_DOMAIN__EVIDENCE: return CapabilityPackage.PROVIDED_CAPABILITY__EVIDENCE;
				default: return -1;
			}
		}
